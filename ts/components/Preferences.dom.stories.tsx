...
export default {
  ...
  args: {
    ...
    preCallScriptPath: undefined,
    hasMaximizeOnCall: false,
    hasMinimizeAfterCall: false,
    postCallScriptPath: undefined,
    ...
    onPreCallScriptPathChange: action('onPreCallScriptPathChange'),
    onMaximizeOnCallChange: action('onMaximizeOnCallChange'),
    onMinimizeAfterCallChange: action('onMinimizeAfterCallChange'),
    onPostCallScriptPathChange: action('onPostCallScriptPathChange'),
